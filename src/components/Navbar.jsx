...
const Navbar = () => {
  ...
  return (
    ...
    }  left-0 right-0 transform translate-y-0 transition-all duration-300 ease-in-out delay-100`}
    ref={headerBox}
    >
      ...
      <Link
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex '>
            Ace &nbsp;
            <span className='sm:block hidden'> | Adegboyega</span>
          </p>
        </Link>
